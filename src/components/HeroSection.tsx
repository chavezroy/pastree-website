...
export default function HeroSection() {
  ...
  const { currentImage, previousImage, isTransitioning, currentIndex } = useImageSlideshow(images, 1000);
  
  // Content groups that match the image groups
  const contentGroups = [
    {
      title: "Supercharge your clipboard with Pastree", 
      subtitle: "Intelligent Lists",
      description: "Organize your clipboard items into smart lists that adapt to your workflow and usage patterns."
    },
    {
      title: "Keyboard Shortcuts",
      subtitle: "Quick Access",
      description: "Add 2 or 3 paste shortcuts to your keyboard!"
    },
    {
      title: "Fast right-click access to clipboard items",
      subtitle: "Fill Forms Fast", 
      description: "Fill forms with your saved clipboard items, lists and starred items with an easy right-click menu."
    },
    {
      title: "Quick Search",
      subtitle: "Find Anything",
      description: "Search through your clipboard history with filtering and highlighting."
    },
    {
      title: "Cross-Device Sync",
      subtitle: "Always Available",
      description: "Export your clipboard to JSON and load it on another computer or browser"
    },
    {
      title: "Privacy First",
      subtitle: "Your Data, Your Control",
      description: "All your clipboard data stays on your device. We never see or store your personal information."
    }
  ];
  
  const currentContent = contentGroups[currentIndex];
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 orange-glow"></div>
      ...
      <div className="container mx-auto px-4 relative z-20 h-full">
        <div className="flex flex-col lg:flex-row items-stretch h-full">
          ...
          <div className="lg:w-1/2 mb-0 py-5 md:py-16 lg:py-24 flex flex-col justify-center">
            ...
            >
              <h1 ref={titleRef} className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-pastree-purple">
                Supercharge your clipboard with {' '}
            ...
            {/* Dynamic content that changes with slideshow */}
            <div 
              className={`transition-all duration-1000 ${
                heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
              style={{ transitionDelay: '200ms', height: '100%' }}
            >
              <div className="rounded-xl mb-6 ps-0">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-2 h-2 bg-pastree-orange rounded-full animate-pulse"></div>
                  <span className="text-pastree-orange font-semibold text-sm uppercase tracking-wide">
                ...
                <p className="text-lg leading-relaxed text-pastree-dark/80">
          ...
          <div className="lg:w-1/2 flex items-center justify-center h-full mt-auto lg:mt-0 min-h-[350px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[675px]">
            <div 
              className={`w-full max-w-md md:max-w-none h-[350px] sm:h-[400px] md:h-[500px] lg:h-[675px] flex items-center justify-center pt-0 pl-8 pr-0 mx-auto md:mx-0 transition-all duration-1200 relative overflow-hidden ${
            ...
            >
              ...
              <img 
                ...
                className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full object-contain transition-opacity ${
                  // Quick transitions within groups (500ms), longer between groups (1000ms)
                  (currentIndex === 0 || currentIndex === 2) ? 'duration-500' : 'duration-1000'
                } ${
              ...
              {/* Previous image for overlap effect - always render but only visible during transition */}
              <img 
                src={previousImage}
                alt="Pastree Clipboard Manager" 
                className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full object-contain transition-opacity ${
