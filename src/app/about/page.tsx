            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="bg-white rounded-xl p-8 hover-shadow-pastree transition-all duration-300 transform hover:-translate-y-2 group">
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-gray-500 mx-auto mb-6 group-hover:scale-125 group-hover:-translate-y-3 group-hover:rotate-3 transition-all duration-700 ease-out">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-white rounded-xl p-8 hover-shadow-pastree transition-all duration-300 transform hover:-translate-y-2 text-center group">
                <div className="w-16 h-16  rounded-2xl flex items-center justify-center text-gray-600 mx-auto mb-6 group-hover:scale-125 group-hover:-translate-y-3 group-hover:rotate-3 transition-all duration-700 ease-out">
                  <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
